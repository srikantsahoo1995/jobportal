...
public class NaukriAutoUpdate {
	...
	static String resumeHeadline = "{\r\n"
			+ "    \"profile\": {\r\n"
			+ "        \"resumeHeadline\": \"Experienced SDET with nearly 6 years in designing, developing, and implementing automated test frameworks. Proficient in various automation tools, passionate about innovation, and skilled in AppSec, SaaS, and enterprise apps.\"\r\n"
			+ "    },\r\n"
